    ...
    return Scaffold(
      body: _selectedIndex == 1
          ...
          : _selectedIndex == 2
              ...
              : RefreshIndicator(
                  onRefresh: () async {
                    context.read<HomepageBloc>().add(HomepageDataFetchEvent());
                  },
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: Theme.of(context).textTheme.headline5?.apply(
                                fontWeightDelta: 3, fontSizeFactor: 1.2),
                          ),
                          const Gap(20),
                          Padding(
      ...
      floatingActionButton: _selectedIndex == 1
          ? FloatingActionButton.small(
              onPressed: () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (BuildContext context) => GraphQLConsumer(
                    builder: (GraphQLClient client) => BlocProvider<EventBloc>(
